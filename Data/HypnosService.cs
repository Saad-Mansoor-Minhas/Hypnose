        ...
        static HypnosService()
        {
            Quesions = new List<HypnosQuestion>()
            {
                 ...
                 new HypnosQuestion
                {
                    ...
                    Choices = new List<string> {"0", "1-3",">3" },
                    AnswerIndex = 1,
                    Score = 3
                },
                  new HypnosQuestion
                {
                    ...
                    Choices = new List<string> {"Back", "side","stomach","recliner" },
                    AnswerIndex = 1,
                    Score = 3
                 },
                 new HypnosQuestion
    ...
    new HypnosQuestion
      ...
      /*       Sleepniess */
                ...
                new HypnosQuestion
                {
                    ...
                    Choices = new List<string> { "(0-3 months", "3-6 months", "6-12 months", "> 12 months" },
                    AnswerIndex = 1,
                    Score = 3
                },
                  new HypnosQuestion
                        ...
                        new HypnosQuestion
                {
                    ...
                    Choices = new List<string> {"<1", "1-2","2-4",">4" },
                    AnswerIndex = 1,
                    Score = 3
                },
